...
import '../../flows/auth/presentation/pages/sign_up/cubit/sign_up_cubit.dart'
    as _i38;
import '../../flows/main/data/datasource/events_datasource.dart' as _i24;
import '../../flows/main/data/repositories/events_repository_impl.dart' as _i26;
import '../../flows/main/domain/repositories/events_repository.dart' as _i25;
import '../../flows/main/domain/usecases/add_event.dart' as _i34;
import '../../flows/main/domain/usecases/get_users_events.dart' as _i27;
...
import '../../flows/main/presentation/pages/main/cubit/main_page_cubit.dart'
    as _i29;
import '../../flows/menu/data/datasource/calendar_events_datasource.dart'
    as _i21;
import '../../flows/menu/data/repositories/calendar_events_repository_impl.dart'
    as _i23;
import '../../flows/menu/domain/repositories/calendar_events_repository.dart'
    as _i22;
import '../../flows/menu/domain/usecases/get_users_month_events.dart' as _i28;
...
import '../token_service/token_service.dart' as _i33;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i21.CalendarEventsDataSourceI>(() =>
      _i21.EventsDataSourceImpl(firestoreEvents: get<_i8.FirestoreEvents>()));
  gh.factory<_i22.CalendarEventsRepositoryI>(() =>
      _i23.CalendarEventsRepositoryImpl(get<_i21.CalendarEventsDataSourceI>()));
  gh.factory<_i24.EventsDataSourceI>(() =>
      _i24.EventsDataSourceImpl(firestoreEvents: get<_i8.FirestoreEvents>()));
  gh.factory<_i25.EventsRepositoryI>(
      () => _i26.EventsRepositoryImpl(get<_i24.EventsDataSourceI>()));
  gh.factory<_i27.GetUsersEventsUseCase>(
      () => _i27.GetUsersEventsUseCase(get<_i25.EventsRepositoryI>()));
  gh.factory<_i28.GetUsersMonthEventsUseCase>(() =>
      _i28.GetUsersMonthEventsUseCase(get<_i22.CalendarEventsRepositoryI>()));
  gh.factory<_i29.MainPageCubit>(() =>
      _i29.MainPageCubit(getUsersEvents: get<_i27.GetUsersEventsUseCase>()));
  gh.factory<_i30.SignInUseCase>(
      () => _i30.SignInUseCase(get<_i19.AuthRepositoryI>()));
  gh.factory<_i31.SignOutUseCase>(
      () => _i31.SignOutUseCase(get<_i19.AuthRepositoryI>()));
  gh.factory<_i32.SignUpUseCase>(
      () => _i32.SignUpUseCase(get<_i19.AuthRepositoryI>()));
  gh.singleton<_i33.TokenManager>(_i33.TokenManager(
    secureStorage: get<_i10.FlutterSecureStorage>(),
    authRepository: get<_i17.AuthRepositoryI>(),
  ));
  gh.factory<_i34.AddEventUseCase>(
      () => _i34.AddEventUseCase(get<_i25.EventsRepositoryI>()));
  gh.factory<_i35.AppStateCubit>(() => _i35.AppStateCubit(
        authRepository: get<_i17.AuthRepositoryI>(),
        firebaseAuth: get<_i6.FirebaseAuth>(),
      ));
  gh.factory<_i36.CalendarCubit>(() => _i36.CalendarCubit(
      getUsersMonthEvents: get<_i28.GetUsersMonthEventsUseCase>()));
  gh.factory<_i37.SignInCubit>(
      () => _i37.SignInCubit(get<_i30.SignInUseCase>()));
  gh.factory<_i38.SignUpCubit>(
      () => _i38.SignUpCubit(get<_i32.SignUpUseCase>()));
  gh.factory<_i39.AddEventCubit>(
      () => _i39.AddEventCubit(addEventUseCase: get<_i34.AddEventUseCase>()));
  return get;
}
