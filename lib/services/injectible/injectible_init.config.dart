...
import '../../flows/auth/domain/usecases/sign_in.dart' as _i29;
import '../../flows/auth/domain/usecases/sign_out.dart' as _i30;
import '../../flows/auth/domain/usecases/sign_up.dart' as _i31;
...
import '../../flows/main/domain/usecases/get_event.dart' as _i25;
import '../../flows/main/domain/usecases/get_events_for_month.dart' as _i26;
import '../../flows/main/domain/usecases/get_users_events.dart' as _i27;
import '../../flows/main/domain/usecases/update_event.dart' as _i33;
...
import '../token_service/token_service.dart' as _i32;
import 'injectible_init.dart' as _i42; // ignore_for_file: unnecessary_lambdas
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i25.GetEventUseCase>(
      () => _i25.GetEventUseCase(get<_i22.EventsRepositoryI>()));
  gh.factory<_i26.GetUsersEventsForMonthUseCase>(
      () => _i26.GetUsersEventsForMonthUseCase(get<_i22.EventsRepositoryI>()));
  gh.factory<_i27.GetUsersEventsUseCase>(
      () => _i27.GetUsersEventsUseCase(get<_i22.EventsRepositoryI>()));
  gh.factory<_i28.MainPageCubit>(() => _i28.MainPageCubit(
        getUsersEvents: get<_i27.GetUsersEventsUseCase>(),
        getCategories: get<_i24.GetCategoriesUseCase>(),
      ));
  gh.factory<_i29.SignInUseCase>(
      () => _i29.SignInUseCase(get<_i19.AuthRepositoryI>()));
  gh.factory<_i30.SignOutUseCase>(
      () => _i30.SignOutUseCase(get<_i19.AuthRepositoryI>()));
  gh.factory<_i31.SignUpUseCase>(
      () => _i31.SignUpUseCase(get<_i19.AuthRepositoryI>()));
  gh.singleton<_i32.TokenManager>(_i32.TokenManager(
    secureStorage: get<_i10.FlutterSecureStorage>(),
    authRepository: get<_i17.AuthRepositoryI>(),
  ));
  gh.factory<_i33.UpdateEventUseCase>(
      () => _i33.UpdateEventUseCase(get<_i22.EventsRepositoryI>()));
  gh.factory<_i34.AddEventUseCase>(
      () => _i34.AddEventUseCase(get<_i22.EventsRepositoryI>()));
  gh.factory<_i35.AppStateCubit>(() => _i35.AppStateCubit(
        authRepository: get<_i17.AuthRepositoryI>(),
        firebaseAuth: get<_i6.FirebaseAuth>(),
      ));
  gh.factory<_i36.CalendarCubit>(
      () => _i36.CalendarCubit(get<_i26.GetUsersEventsForMonthUseCase>()));
  gh.factory<_i37.EditEventCubit>(() => _i37.EditEventCubit(
        get<_i25.GetEventUseCase>(),
        get<_i33.UpdateEventUseCase>(),
      ));
  gh.factory<_i38.EventCubit>(
      () => _i38.EventCubit(get<_i25.GetEventUseCase>()));
  gh.factory<_i39.SignInCubit>(
      () => _i39.SignInCubit(get<_i29.SignInUseCase>()));
  gh.factory<_i40.SignUpCubit>(
      () => _i40.SignUpCubit(get<_i31.SignUpUseCase>()));
  gh.factory<_i41.AddEventCubit>(() => _i41.AddEventCubit(
        addEventUseCase: get<_i34.AddEventUseCase>(),
